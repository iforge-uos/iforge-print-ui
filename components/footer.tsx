  ...
  return (
    <footer className="bg-secondary dark:bg-muted">
      <div className="mw-300 container mx-auto py-4">
        ...
        <div className="container mx-auto mt-8 flex items-center justify-between gap-6 py-4 ">
          <div className="">
            <h3 className="mb-2 scroll-m-20 text-xl font-bold tracking-tight">
              iForge
            </h3>
          </div>
          ...
          <div className="flex space-x-4">
            ...
            <a href="/" className="text-white hover:text-green-500"></a>
            <a href="/" className="text-white hover:text-green-500"></a>
          </div>
        </div>
      </div>
