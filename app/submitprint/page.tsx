          ...
          <div className="pt-20 ">
            <Card className="mb-8 w-[350px]">
              <CardHeader>
                ...
                <CardDescription>
                  The normal technology people think of when they say 3D
                  printing – it works by extruding hot plastic in layers and
                  gradually building up a model.
                </CardDescription>
              </CardHeader>
            ...
            <Card className="w-[350px]">
              <CardHeader>
                ...
                <CardDescription>
                  Liquid resin based technology, using a laser to cure
                  photosensitive resin layer by layer to build up a part.
                </CardDescription>
              </CardHeader>
