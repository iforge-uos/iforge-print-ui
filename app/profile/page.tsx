...
import { Activity, Printer, Timer, Users } from "lucide-react"
...
import { columns, Prints } from "@/app/admin/components/columns"
    ...
    <>
      <div className="flex">
        ...
        <section className="container grid items-center gap-6 pb-8 pt-6 md:py-10 ">
          ...
          <div className="grid grid-cols-2 gap-4 pt-10 md:grid-cols-2 lg:grid-cols-4">
            <Card className="max-w-xs bg-secondary shadow">
              ...
              <CardContent>
                <div className="text-2xl font-bold text-green-600">
                  {" "}
                  {serverLevel &&
                    serverLevel.charAt(0).toUpperCase() + serverLevel.slice(1)}
                </div>
                <p className="text-xs text-muted-foreground">
                  This is the level which determines your access to independent
                  prints.
                </p>
              </CardContent>
            </Card>
          ...
          <div className="max-w-screen grid gap-4 pt-5 md:grid-cols-2">
            <Card className="max-h-60 max-w-sm lg:max-h-[600px] lg:max-w-[660px] xl:max-h-[600px] xl:max-w-[660px]">
            ...
            <Card className="max-h-lg max-w-lg">
              ...
              <CardContent className="text-xs text-muted-foreground">
                ...
                Praesent eu tincidunt tortor, a pulvinar nunc. Sed laoreet
                finibus enim, vel rutrum augue molestie eget. In mattis leo et
                arcu accumsan, non dictum ante fermentum. Donec turpis dui,
                vestibulum vel odio in, dictum convallis quam. Praesent ultrices
                vel sem non placerat. Mauris porta, lorem eu interdum efficitur,
                eros odio consectetur ipsum, vitae finibus enim ante a enim.
              </CardContent>
            </Card>
          </div>
