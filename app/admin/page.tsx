        ...
        <div className="grid gap-4 pt-5 md:grid-cols-2">
          ...
          <Card className="max-h-[250px] max-w-[330px]">
            ...
            <CardContent className="text-xs text-muted-foreground">
              ...
              eu tincidunt tortor, a pulvinar nunc. Sed laoreet finibus enim,
              vel rutrum augue molestie eget. In mattis leo et arcu accumsan,
              non dictum ante fermentum. Donec turpis dui, vestibulum vel odio
              in, dictum convallis quam. Praesent ultrices vel sem non placerat.
              Mauris porta, lorem eu interdum efficitur, eros odio consectetur
              ipsum, vitae finibus enim ante a enim.
            </CardContent>
          </Card>
        </div>
        <div>
